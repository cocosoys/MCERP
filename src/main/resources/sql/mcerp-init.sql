...
('1', '示例boolean',   'example.test.boolean', 'false', 'Y', '示例boolean', '2026-09-11 00:00:00'),
('2', '示例string', 'example.test.string',   'false', 'Y', '示例string', '2026-09-11 00:00:00');
...
('1', '0', '系统管理', 1, '/system', 'Layout', '', '', '1', '0',                  'M', 'mcerp:system:dir:view',                    'system',    '0', '0', 'Y'),
('2', '1', '用户管理', 1, 'user',      'system/user/index', '', '', '1', '0',         'C', 'mcerp:system:user:list',           'user',      '0', '0', 'Y'),
('3', '1', '菜单管理', 2, 'menu',      'system/menu/index', '', '', '1', '0',         'C', 'mcerp:system:menu:list',           'menu',      '0', '0', 'Y'),
('4', '1', '字典管理', 3, 'dict',      'system/dict/index', '', '', '1', '0',         'C', 'mcerp:system:dict:list',           'dict',      '0', '0', 'Y'),
('5', '1', '参数设置', 4, 'config',    'system/config/index', '', '', '1', '0',       'C', 'mcerp:system:config:list',         'config',    '0', '0', 'Y'),
('6', '1', '通知公告', 5, 'notice',    'system/notice/index', '', '', '1', '0',       'C', 'mcerp:system:notice:list',         'notice',    '0', '0', 'Y'),
('7', '1', '日志管理', 6, 'log',       'Layout', '', '', '1', '0',                    'M', 'mcerp:monitor:dir:view',                    'log',       '0', '0', 'Y'),
('8', '7', '操作日志', 1, 'operlog',   'monitor/operlog/index', '', '', '1', '0',     'C', 'mcerp:monitor:operlog:list',       'operlog',   '0', '0', 'Y'),
('9', '7', '登录日志', 2, 'logininfor','monitor/logininfor/index', '', '', '1', '0',  'C', 'mcerp:monitor:logininfor:list',    'logininfor','0', '0', 'Y'),
('10', '2', '用户查询', 1, '', '', '', '', '1', '0', 'F', 'mcerp:system:user:query',      '', '0', '0', 'Y'),
('11', '2', '用户新增', 2, '', '', '', '', '1', '0', 'F', 'mcerp:system:user:add',        '', '0', '0', 'Y'),
('12', '2', '用户修改', 3, '', '', '', '', '1', '0', 'F', 'mcerp:system:user:edit',       '', '0', '0', 'Y'),
('13', '2', '用户删除', 4, '', '', '', '', '1', '0', 'F', 'mcerp:system:user:remove',     '', '0', '0', 'Y'),
('14', '2', '重置密码', 5, '', '', '', '', '1', '0', 'F', 'mcerp:system:user:resetPwd',   '', '0', '0', 'Y'),
('15', '2', '用户状态', 6, '', '', '', '', '1', '0', 'F', 'mcerp:system:user:changeStatus','', '0', '0', 'Y'),
('16', '2', '用户导出', 7, '', '', '', '', '1', '0', 'F', 'mcerp:system:user:export',     '', '0', '0', 'Y'),
('17', '3', '菜单查询', 1, '', '', '', '', '1', '0', 'F', 'mcerp:system:menu:query',      '', '0', '0', 'Y'),
('18', '3', '菜单新增', 2, '', '', '', '', '1', '0', 'F', 'mcerp:system:menu:add',        '', '0', '0', 'Y'),
('19', '3', '菜单修改', 3, '', '', '', '', '1', '0', 'F', 'mcerp:system:menu:edit',       '', '0', '0', 'Y'),
('20', '3', '菜单删除', 4, '', '', '', '', '1', '0', 'F', 'mcerp:system:menu:remove',     '', '0', '0', 'Y'),
('21', '4', '字典查询', 1, '', '', '', '', '1', '0', 'F', 'mcerp:system:dict:query',      '', '0', '0', 'Y'),
('22', '4', '字典新增', 2, '', '', '', '', '1', '0', 'F', 'mcerp:system:dict:add',        '', '0', '0', 'Y'),
('23', '4', '字典修改', 3, '', '', '', '', '1', '0', 'F', 'mcerp:system:dict:edit',       '', '0', '0', 'Y'),
('24', '4', '字典删除', 4, '', '', '', '', '1', '0', 'F', 'mcerp:system:dict:remove',     '', '0', '0', 'Y'),
('25', '5', '参数查询', 1, '', '', '', '', '1', '0', 'F', 'mcerp:system:config:query',    '', '0', '0', 'Y'),
('26', '5', '参数新增', 2, '', '', '', '', '1', '0', 'F', 'mcerp:system:config:add',      '', '0', '0', 'Y'),
('27', '5', '参数修改', 3, '', '', '', '', '1', '0', 'F', 'mcerp:system:config:edit',     '', '0', '0', 'Y'),
('28', '5', '参数删除', 4, '', '', '', '', '1', '0', 'F', 'mcerp:system:config:remove',   '', '0', '0', 'Y'),
('29', '6', '公告查询', 1, '', '', '', '', '1', '0', 'F', 'mcerp:system:notice:query',    '', '0', '0', 'Y'),
('30', '6', '公告新增', 2, '', '', '', '', '1', '0', 'F', 'mcerp:system:notice:add',      '', '0', '0', 'Y'),
('31', '6', '公告修改', 3, '', '', '', '', '1', '0', 'F', 'mcerp:system:notice:edit',     '', '0', '0', 'Y'),
('32', '6', '公告删除', 4, '', '', '', '', '1', '0', 'F', 'mcerp:system:notice:remove',   '', '0', '0', 'Y'),
('33', '8', '日志查询', 1, '', '', '', '', '1', '0', 'F', 'mcerp:monitor:operlog:query',  '', '0', '0', 'Y'),
('34', '8', '日志导出', 2, '', '', '', '', '1', '0', 'F', 'mcerp:monitor:operlog:export', '', '0', '0', 'Y'),
('35', '8', '日志删除', 3, '', '', '', '', '1', '0', 'F', 'mcerp:monitor:operlog:remove', '', '0', '0', 'Y'),
('36', '8', '日志清空', 4, '', '', '', '', '1', '0', 'F', 'mcerp:monitor:operlog:clean',  '', '0', '0', 'Y'),
('37', '9', '日志查询', 1, '', '', '', '', '1', '0', 'F', 'mcerp:monitor:logininfor:query',  '', '0', '0', 'Y'),
('38', '9', '日志导出', 2, '', '', '', '', '1', '0', 'F', 'mcerp:monitor:logininfor:export', '', '0', '0', 'Y'),
('39', '9', '日志删除', 3, '', '', '', '', '1', '0', 'F', 'mcerp:monitor:logininfor:remove', '', '0', '0', 'Y'),
('40', '9', '日志清空', 4, '', '', '', '', '1', '0', 'F', 'mcerp:monitor:logininfor:clean',  '', '0', '0', 'Y');
