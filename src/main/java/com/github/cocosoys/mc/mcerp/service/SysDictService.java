 ...
 * 实现见 {@link com.github.cocosoys.mc.mcerp.impl.SysDictServiceImpl}；
...
public interface SysDictService {
    ...
    AjaxResult typeAdd(SysDictType body);

    AjaxResult typeUpdate(String dictId, SysDictType body);
    ...
    AjaxResult dataAdd(SysDictData body);

    AjaxResult dataUpdate(String dictCode, SysDictData body);
